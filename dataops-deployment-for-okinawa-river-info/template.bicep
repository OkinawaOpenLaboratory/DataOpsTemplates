...
@description('データベース名。')
param databaseName string = 'OkinawaRiverInfo'
...
resource cosmosReadWriteId 'Microsoft.ManagedIdentity/userAssignedIdentities@2018-11-30' = {
  name: cosmosReadWriteManagedID
  location: location
}
...
resource rainsContainer 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2021-07-01-preview' = {
  parent: cosmosDB
  name: 'rains'
  properties: {
    resource: {
...
resource waterLevelsContainer 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers@2021-07-01-preview' = {
  parent: cosmosDB
  name: 'waterLevels'
  properties: {
    resource: {
...
resource rainsThroughputSettings 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/throughputSettings@2021-07-01-preview' = {
  parent: rainsContainer
  name: 'default'
  properties: {
    resource: {
      throughput: 400
...
resource waterLevelsThroughputSettings 'Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers/throughputSettings@2021-07-01-preview' = {
  parent: waterLevelsContainer
  name: 'default'
  properties: {
    resource: {
      throughput: 400
...
resource cosmosDBPrivateEndpoint 'Microsoft.Network/privateEndpoints@2020-11-01' = {
  ...
  properties: {
    ...
    customDnsConfigs: [
      {
        fqdn: '${cosmosDBAccount.name}.documents.azure.com'
        ipAddresses: [
          '10.0.1.7'
        ]
      }
      {
        fqdn: '${cosmosDBAccount.name}-japaneast.documents.azure.com'
        ipAddresses: [
          '10.0.1.8'
        ]
      }
...
resource privateDnsZoneA02 'Microsoft.Network/privateDnsZones/A@2018-09-01' = {
  parent: cosmosDBPrivateDnsZone
  name: '${cosmosDBAccount.name}-japaneast'
  properties: {
    ttl: 3600
    aRecords: [
      {
