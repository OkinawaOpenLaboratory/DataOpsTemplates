...
ユーザー割り当てマネージド ID を使用したデータ登録の方法は[こちら](https://raw.githubusercontent.com/OkinawaOpenLaboratory/DataOpsTemplates/main/usecases/river-water-level-collection/data-registration-with-rbac/README.md)を参照してください。 
